...
class CustomComboBox<E> extends JComboBox<E> {
    ...
    public static class CustomComboBoxUI extends MetalComboBoxUI {
        ...
        protected ComboPopup createPopup(){
            return new SingleSelectComboBoxPopup (comboBox);
        }
        public class SingleSelectComboBoxPopup extends BasicComboPopup {

            public SingleSelectComboBoxPopup(JComboBox<?> cBox) {
                super(cBox);
            }
